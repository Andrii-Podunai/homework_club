...
test("get started link", async ({ page }) => {
  let pumaLandingPage = new PumaLandingPage(page);
...
test("check modal of feedback", async ({ page }) => {
  let pumaLandingPage = new PumaLandingPage(page);
  await pumaLandingPage.goto();
...
test("check modal of Select a Location", async ({ page }) => {
  let pumaLandingPage = new PumaLandingPage(page);
  await pumaLandingPage.goto();
...
test("check Select a Location", async ({ page }) => {
  let pumaLandingPage = new PumaLandingPage(page);
  await pumaLandingPage.goto();
...
test("check sale", async ({ page }) => {
  ...
  await console.log(`${expectedDecoration}`);
